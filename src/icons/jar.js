...
const Jar = props => {
  ...
  return (
    <svg
      ...
      id="Jar"
    >
      <path d="M3 9l1.164 8.926a3.875 3.875 0 002.844 3.243v0c3.27.872 6.713.872 9.984 0v0a3.875 3.875 0 002.844-3.243L21 9"></path>
      ...
      <path d="M15 4v0a2 2 0 00-2-2h-2a2 2 0 00-2 2v0"></path>
    </svg>
  );
};
